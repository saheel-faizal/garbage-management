...
if(isset($_POST['sub']))
{
  ...
  $place=$_POST['place'];           
    ...
    mysqli_query($conn,"INSERT INTO garbage_tb(g_name,latitude,longitude,g_place) VALUES ('$nm','$lt','$lg','$place')");
    echo "<script>alert('New Bin Added')</script>";
              ...
              <form method="post">
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <input class="form-control"  type="text" onclick="clr('sp2')" name="lati" id="phone_id" >
                  <span id="sp2" style="color: white;background-color: red;"></span>
                </div>
                 <div class="form-group">
                  <label class="control-label">Longitude    </label>
                  <input class="form-control" type="text" onclick="clr('sp3')" name="long" id="email_id" >
                  <span id="sp3" style="color: white;background-color: red;"></span>
                </div>
               
                <div class="form-group">
                  <label class="control-label">Place</label>
                  <textarea class="form-control" rows="4" onclick="clr('sp5')" name="place" id="address_id" ></textarea>
